...
export default function Navbar({logo}) {
  return (
    ...
    <nav className = "bg-[url('/src/images/nav.jpg')]">
    ...
    <div className = 'w-full flex flex-row justify-between py-5 items-center'>
      <div className = "text-2xl font-extrabold pl-5 text-orange-500"> {logo} </div>
      ...
      <button className = "bg-black text-xl font-bold px-4 py-2 rounded-full mr-4 text-orange-500 ">Contact Us!</button>
    </div>
  </nav>
  )
}
